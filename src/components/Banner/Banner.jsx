            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
              ...
              <div className="flex flex-col justify-center gap-6 sm:pt-0">
                ...
                <p className="text-sm text-gray-500 tracking-wide leading-5">
                  Nikmati sensasi bakso prasmanan dengan beragam pilihan topping dan kuah
                  yang menggugah selera. Bebas pilih sesuai selera, puas tanpa batas!
                  <br />
                  <br />
                  Cita rasa autentik yang selalu bikin ketagihan. Ayo, mampir dan rasakan
                  kelezatannya di setiap suapan!
                </p>
